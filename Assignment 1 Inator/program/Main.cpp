...
try{
    ...
    if(algorithmSelected == "pds_visited_list" ){            
        ...
        path = progressiveDeepeningSearch_VisitedList(initialState,  goalState, numOfStateExpansions, maxQLength, actualRunningTime, 100);       


    } else if(algorithmSelected == "pds_nonstrict_visited_list" ){            
        
        path = progressiveDeepeningSearch_NonStrict_VisitedList(initialState,  goalState, numOfStateExpansions, maxQLength, actualRunningTime, 100);       
   
                          
    } else if(algorithmSelected == "best_first_visited_list" ){
        
        path = bestFirstSearch_with_VisitedList(initialState, goalState, numOfStateExpansions, maxQLength, actualRunningTime);    
     
    } else if(algorithmSelected == "best_first_no_visited_list" ){
        
        path = bestFirstSearch_No_VisitedList(initialState, goalState, numOfStateExpansions, maxQLength, actualRunningTime);    
...
//-----------------------------------------------------------------------------
    ...
    if(algorithmSelected == "pds_visited_list" ){
        cout << setw(31) << std::left << "1) pds_visited_list"; 

    } else if(algorithmSelected == "pds_nonstrict_visited_list" ){
        cout << setw(31) << std::left << "2) pds_nonstrict_visited_list"; 
    
    } else if(algorithmSelected == "best_first_no_visited_list" ){
        cout << setw(31) << std::left << "3) best_first_no_visited_list";                    

    } else if(algorithmSelected == "best_first_visited_list" ){
        cout << setw(31) << std::left << "4) best_first_visited_list";  
	...
	if(typeOfRun == "batch_run"){	
        ...
        cout  << setprecision(6) << std::setfill(' ')   << std::fixed << std::right << ' ' << setw(10) << initialState; 
        cout  << setprecision(6) << std::setfill(' ')   << std::fixed << std::right << ' ' << setw(10) << goalState; 
